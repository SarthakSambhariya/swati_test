...
const ContractorListing2 = ({
  ...
  return (
    <React.Fragment>
   {screenWidth>768 && <div className="d-flex mx-2" style={{width:"25.8125rem"}}>
      <div
        className="mb-3 "
        style={{ border: "2px solid rgba(127, 135, 144, 0.2)",width:"25.8125rem",height:"33.25rem" }}
      >
        <div className="" key={id} >
          ...
          <div className="col-lg-5 col-md-12 socialpart p-3" style={{width:"100%"}}>
                ...
                >
                  <div style={{ display: "flex", alignItems: "center" }}>
                    <p className="mt-2 d-inline dlsize">
                      {name.length > 18 ? `${name.substr(0, 9)}...` : name}
                    </p>
            ...
            <div
              ...
              style={{ width: "108%", background: "#F5F5F5",transform:"translateX(-0.95rem)" }}
            >
              <div
              ...
              >
                ...
                <p style={{ fontSize: "0.75rem", fontFamily: "Public Sans" }}>
                  ₹50 sqft
                </p>
              </div>
              <div
      ...
      >
        <div className="" key={id}>
          ...
          <div className="col-lg-5 col-md-12 socialpart p-3">
            ...
            <div
              className="d-flex justify-content-center flex-column align-items-center p-3 mt-2"
              style={{ width: "110%", background: "#F5F5F5",transform:"translateX(-1.2rem)" }}
            >
              <div
                className="d-flex justify-content-between align-items-center"
                style={{ width: "45%" }}
