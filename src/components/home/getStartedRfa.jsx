    ...
    {!secondForm && (
        ...
        <div className="modal-body text-dark">
            ...
            <div className="row">
              ...
              <div>
                ...
                <button
                  type="button"
                  value={contractor}
                  onClick={() => setContractor(!contractor)}
                  className={
                    contractor
                      ? "btn btn-light border pl-1 blue text-white"
                      : "btn btn-light border pl-1"
          ...
          <div className="text-center border-light">
            <div className="d-grid gap-2 col-12">
              <button
                className="btn text-light mt-2 blue"
                type="submit"
      ...
      {secondForm && (
        <div className="modal-body p-4 text-dark">
          ...
          <div>
            <ul className="nav nav-pills" style={{maxWidth:"none"}} id="pills-tab" role="tablist">
